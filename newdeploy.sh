...
# 運行新的容器
echo "運行新的容器..."
docker run -idt --name img2tag --network="host" -e RABBITMQ_HOST=192.168.2.232 -e RABBITMQ_PORT=5672 -e RABBITMQ_USER=james -e RABBITMQ_PASSWORD=Imagedj89684152 -v /var/www/html/rabbit/uploads:/app/uploads img2tag:latest
